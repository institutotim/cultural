                ...
                <div class="event__venue">
                   ...
                   <div class="event_time">
                    ...
                    <div class="event__time">            
                        <figure ng-if="event.avatar.avatarBig.url" class="event__image " style="background:transparent" >
                            <img ng-src="{{event.avatar.avatarBig.url}}" alt="{{event.name}}" class="caixa_corte imagem-eventos" />
