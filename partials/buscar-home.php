            ...
            <div class="dropdown">
                ...
                <div class="submenu-dropdown">
                    <ul class="lista-de-filtro select">
                        <li ng-repeat="linguagem in data.linguagens" ng-class="{'selected': linguagem.active}" ng-

click="toggleListItem('linguagens', linguagem)" class="ng-scope">
        ...
        <div ng-if="data.classificacoes" class="filter">
            ...
            <div id="classificacao" class="dropdown">
                ...
                <div class="submenu-dropdown">
                    <ul class="lista-de-filtro select">
                        <li ng-repeat="classificacao in data.classificacoes" ng-class="{'selected': classificacao.active}" ng-

click="toggleListItem('classificacoes', classificacao)" class="ng-scope">
...
'cultural'); ?>' : '<?php _e('eventos encontrados', 'cultural'); ?>'}}</h3>
   ...
   <!--            <figure ng-if="event['@files:avatar.avatarMedium']" class="event__image" style="background:transparent" >
            ...
            <div class="event-data">
                ...
                <dicv class="event__occurrences" ng-repeat="occs in event.occurrences" ng-if="occs.inPeriod">
                    <div class="event__venue">
                        <a href="{{occs.space.singleUrl}}">{{occs.space.name}}</a>
                        <div class="event__time">{{event.occurrence}}</div>
                    </div>
                    <div class="event__time">{{occs.rule.description}}</div><br />
                    <!-- <div class="event__time" data-edit="endereco" >Endereco</div><br /> -->
                    <div class="event__time">            
                        <figure ng-if="event['@files:avatar.avatarBig']" class="event__image" style="background:transparent" >
                            <img ng-src="{{event['@files:avatar.avatarBig'].url}}" alt="{{event.name}}" class="caixa_corte" />
