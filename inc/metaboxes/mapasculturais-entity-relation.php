...
class MCEntityRelationMetabox {
    ...
    static function metabox(){
        ...
        $metadata2 = get_metadata('post', $post->ID, 'mc-entity-relation-2', true);
        $metadata3 = get_metadata('post', $post->ID, 'mc-entity-relation-3', true);
        $metadata4 = get_metadata('post', $post->ID, 'mc-entity-relation-4', true);
        $metadata5 = get_metadata('post', $post->ID, 'mc-entity-relation-5', true);
        $metadata6 = get_metadata('post', $post->ID, 'mc-entity-relation-6', true);
        ...
        <input type="text" name="<?php echo __CLASS__ ?>[mc-entity-relation]" value="<?php echo $metadata; ?>" style="width:100%" placeholder="Informe aqui a url incluindo o http://"/> 
        <input type="text" name="<?php echo __CLASS__ ?>[mc-entity-relation-2]" value="<?php echo $metadata2; ?>" style="width:100%" placeholder="Informe aqui a url incluindo o http://"/> 
        <input type="text" name="<?php echo __CLASS__ ?>[mc-entity-relation-3]" value="<?php echo $metadata3; ?>" style="width:100%" placeholder="Informe aqui a url incluindo o http://"/> 
        <input type="text" name="<?php echo __CLASS__ ?>[mc-entity-relation-4]" value="<?php echo $metadata4; ?>" style="width:100%" placeholder="Informe aqui a url incluindo o http://"/> 
        <input type="text" name="<?php echo __CLASS__ ?>[mc-entity-relation-5]" value="<?php echo $metadata5; ?>" style="width:100%" placeholder="Informe aqui a url incluindo o http://"/> 
        <input type="text" name="<?php echo __CLASS__ ?>[mc-entity-relation-6]" value="<?php echo $metadata6; ?>" style="width:100%" placeholder="Informe aqui a url incluindo o http://"/> 
        <?php
    }
