    ...
    static function renderPage() {
        ...
        <div class="wrap span-20">
            ...
            <form action="options.php" method="post" class="clear prepend-top">
                ...
                <div class="span-20 ">
                    <p class="help">
                        <?php _e("Cole na caixas abaixo as URLs dos posts que você deseja destacar para cada seção do site, uma URL por linha, na ordem que você deseja que apareça.<br>Deixe em branco se desejar que sejam destacados os últimos posts.<br>Deixa a data de expiração vazia para que os post sempre seja exibido.",'cultural'); ?>
                    </p>
